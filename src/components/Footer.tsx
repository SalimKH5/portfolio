...
const Footer = () => {
  return (
    <div className='bg-transparent dark:bg-slate-600/80 border-t backdrop-blur-lg flex items-center justify-center py-2 fixed bottom-0 left-0 right-0  w-full z-50'>
