...
const ProjectContainer = ({ propos }: { propos: IWork }) => {
    ...
    return (
        ...
        >
            <div
                className={`absolute inset-0 left-0 right-0 flex items-center justify-center  bg-[#000000] rounded-3xl transition-transform  duration-700 ease-in-out ${hover ? 'opacity-95 translate-y-0 top-0 z-50' : 'opacity-0 translate-y-full'}`}
            >
